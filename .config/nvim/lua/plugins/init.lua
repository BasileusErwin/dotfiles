...
M.setup = function()
  local plugins = function(use)
    ...
    use {
      ...
      config = require('plugins.config.diagnosticls').setup()
    }
    use {
    ...
    use {
      ...
      config = require('plugins.config.colorize').setup()
    }

    -- Commentary
    use {
      'numToStr/Comment.nvim',
      config = require('plugins.config.comments').setup()
    }
    ...
    use {
      ...
      config = require('plugins.config.git').setup()
    }
    -- Telescope
    use {
    ...
    use {
      ...
      config = require('plugins.config.icons').setup()
    }
    use { 'ryanoasis/vim-devicons' }

    use {
      'nathom/filetype.nvim',
      config = require('plugins.config.filetype').setup()
    }
    use {
